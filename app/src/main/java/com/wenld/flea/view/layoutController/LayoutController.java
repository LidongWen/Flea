package com.wenld.flea.view.layoutController;
...
import static com.wenld.flea.view.layoutController.LayoutController.Builder.ViewLayoutParams.VIEW_TOGGER;
...
public class LayoutController {
    ...
    public static class Builder {
        ...
        public Builder(Context context, View parent, @LayoutRes Integer layoutRes) {
            this(context, parent, null, layoutRes);
        }

        public Builder(Context context, View parent, ViewGroup.LayoutParams layoutParams, @LayoutRes Integer layoutRes) {
